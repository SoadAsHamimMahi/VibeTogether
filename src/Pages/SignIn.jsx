...
const SignIn = () => {
    return (
        <div className='flex mt-12 w-2/3 mx-auto justify-between'>
            <div className=' w-full my-auto'>
                <h1 className='text-5xl font-bold bg-gradient-to-t from-indigo-500  to-pink-500 bg-clip-text text-transparent'>
                    Vibe Together
                </h1>
                <p className='text-lg w-3/4 mt-7'>Connect With Friends and the world around on Vibe Together</p>
            </div>


            <div className=' w-full'>
                <div className=" mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
